...
let ``A point outside the body bounds is filtered before volume checking`` () =
    let candidates =
        [
            { Location = point3D 5.0 5.0 0.0; Source = { BeamId = "Beam-1"; ControlPointIndex = Some 0; GantryAngle = Some 0.0; SampleType = LineSample } }
            { Location = point3D 50.0 50.0 0.0; Source = { BeamId = "Beam-1"; ControlPointIndex = Some 0; GantryAngle = Some 0.0; SampleType = LineSample } }
        ]
